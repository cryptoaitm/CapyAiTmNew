...
import { imageMap, mainCharacter } from '@/images';
            ...
            <div className="px-4 pt-1 pb-24">
              <div className="relative mt-4">
                <div className="flex justify-center mb-4">
                  <Image src={mainCharacter} alt='ft' className="w-24 h-24 mx-auto" />
                </div>
                <h1 className="text-2xl text-center mb-4">Earn More Capy</h1>
                          ...
                          >
                            <div className="flex items-center">
                              ...
                              <div className="flex flex-col">
                                ...
                                <div className="flex items-center">
                                <Image src={mainCharacter} alt='ft' className="w-6 h-6 mr-1" />
