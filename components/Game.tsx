...
import { binanceLogo, dailyCipher, dailyCombo, dailyReward, dollarCoin, lightning,iceToken,mainCharacter } from '@/images';
            ...
            <div className="px-4 pt-1 pb-24" >
              ...
              <div className="px-4 mt-4 flex justify-center" >
                <div className="px-4 py-2 flex items-center space-x-2" >
                  <Image src={mainCharacter}  alt="Exchange" width={40} height={40} />
              ...
              <div className="flex justify-between px-4 mt-4">
                <p className="flex justify-center items-center gap-1"><IceCube  className="w-12 h-12 mx-auto"   /><span className="flex flex-col"><span className="text-xl font-bold">{energy}</span><span className="text-base font-medium">/ {maxEnergy}</span></span></p>
