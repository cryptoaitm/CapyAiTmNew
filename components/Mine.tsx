            ...
            <div className="px-4 pt-1 pb-24">
              ...
              {/* <div className="bg-[#272a2f] rounded-lg p-4 mt-6 flex items-start">
                                ...
                                <p className="text-sm text-gray-300">
                                    Your mine automatically produces Capy for up to <span className="text-white font-bold">{maxInactiveHours} hours</span> after your last activity. Make sure to check in regularly to maximize your Capy production!
                                </p>
                            </div> */}
              ...
              <div onClick={handleUpgradeTwo}
                // disabled={pointsBalance < upgradeCost || isLoading}
                className={`  p-4 mt-6 mt-6 py-3 rounded-lg text-center text-white font-bold}`}
                 > 
              {/* <button
                onClick={handleUpgrade}
                disabled={pointsBalance < upgradeCost || isLoading}
                className={`mt-6 py-3 rounded-lg text-center text-white font-bold ${
                  pointsBalance >= upgradeCost && !isLoading
                    ? "bg-[#f3ba2f]"
                    : "bg-gray-500 cursor-not-allowed"
                } relative`}
