...
export default function Friends() {
  ...
  const [showBonusesList, setShowBonusesList] = useState(true);
  ...
  const handleCopyInviteLink = useCallback(() => {
    navigator.clipboard
      .writeText(process.env.NEXT_PUBLIC_BOT_USERNAME ? `https://t.me/${process.env.NEXT_PUBLIC_BOT_USERNAME}/${process.env.NEXT_PUBLIC_APP_URL_SHORT_NAME}?startapp=kentId${getUserTelegramId(userTelegramInitData) || ""}` : "https:// t.me/Capy_Community_Bot/capy")
      .then(() => {
  ...
  const handleInviteFriend = useCallback(() => {
    ...
    const inviteLink = botUsername
      ...
      : " t.me/Capy_Community_Bot/capy";

    const shareText = `🎮 Join me in Capy: Tap, Earn, and Win! 🏆\n🚀 Let's play and earn together!`;
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center bg-[#272a2f] rounded-lg p-4">
                    <div className="flex items-center">
                      ...
                      <div className="flex flex-col ml-2">
                        <span className="font-medium">Invite a friend with Telegram</span>
                        <div className="flex items-center">
                          <IceCube className="w-6 h-6" />
